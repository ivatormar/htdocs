    ...
    <div class="content">
        ...
        <div class="revels-container">
            <div class="datos-usuario">
                ...
                <!-- Mostrar el botón "Mis Revels" solo si el usuario actual es el propietario del perfil -->
                <?php if ($_SESSION['user_id'] == $userData['id']) : ?>
                    <a href="/BACKEND/list.inc.php" class="button-34">Mis Revels</a>
                <?php endif; ?>
            </div>
                ...
                <ul>
                    <?php foreach ($userRevels as $revel) : ?>
                        <li>
                            ...
                            <?php if ($_SESSION['user_id'] == $userData['id']) : ?>
                                <form method="post" action="/user/<?php echo urlencode($userData['usuario']); ?>" class="deleteRevelForm">
