        ...
        <body cz-shortcut-listen="true" class="body">
            ...
            <div class="revel-container">
                <div class="revel-box">
                    ...
                    <p class="revel-info">Publicado por <a href="/user.php?id=<?php echo $revel['userid']; ?>"><?php echo htmlspecialchars($revel['autor_usuario']); ?></a> - Fecha: <?php echo htmlspecialchars($revel['fecha']); ?></p>
                </div>
            </div>
            ...
            <div class="comentarios-container">
                ...
                foreach ($comentarios as $comentario) {
                    ...
                    echo '<p class="comentario-info">Comentado por <a href="/user.php?id=' . $comentario['userid'] . '">' . htmlspecialchars($comentario['autor_usuario']) . '</a> - Fecha: ' . htmlspecialchars($comentario['fecha']) . '</p>';
                    echo '</div>';
                }
                ?>
            </div>
            ...
            <div class="nuevo-comentario-form">
                ...
                <form method="post" action="/revel.php?id=<?php echo $revelId; ?>">
                    <div class="mb-3">
